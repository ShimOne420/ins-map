...
struct BarrioBotanicoView: View {
                ...
                VStack(alignment: .leading, spacing: 0) {
                    ...
                    ScrollView{
                        VStack(alignment: .leading, spacing: 20) {
                            ...
                            VStack(alignment: .leading, spacing: 2) {
                                HStack(spacing: 2) {
                                    Image("BarrioBotanicoPost") // Replace with your asset names
                                        .resizable()
                                        .aspectRatio(contentMode: .fill)
                                    ...
                                    Image("BarrioBotanico2") // Replace with your asset names
                                        .resizable()
                                        .aspectRatio(contentMode: .fill)
                                        .frame(width: UIScreen.main.bounds.width / 3, height: UIScreen.main.bounds.height / 4)
                                        .clipped()
                                    ...
                                    Image("BarrioBotanico3") // Replace with your asset names
                                        .resizable()
                                        .aspectRatio(contentMode: .fill)
                                        .frame(width: UIScreen.main.bounds.width / 3, height: UIScreen.main.bounds.height / 4)
                                        .clipped()
                                ...
                                HStack(spacing: 2) {
                                    Image("BarrioBotanico4") // Replace with your asset names
                                        .resizable()
                                        .aspectRatio(contentMode: .fill)
                                        .frame(width: UIScreen.main.bounds.width / 3, height: UIScreen.main.bounds.height / 4)
                                        .clipped()
                                    
                                    Image("BarrioBotanico5") // Replace with your asset names
                                        .resizable()
                                        .aspectRatio(contentMode: .fill)
                                        .frame(width: UIScreen.main.bounds.width / 3, height: UIScreen.main.bounds.height / 4)
                                        .clipped()
                                    ...
                                    Image("BarrioBotanico6") // Replace with your asset names
                                        .resizable()
                                        .aspectRatio(contentMode: .fill)
                                        .frame(width: UIScreen.main.bounds.width / 3, height: UIScreen.main.bounds.height / 4)
                                        .clipped()
                                ...
                                HStack(spacing: 2) {
                                    Image("BarrioBotanico7") // Replace with your asset names
                                        .resizable()
                                        .aspectRatio(contentMode: .fill)
                                        .frame(width: UIScreen.main.bounds.width / 3, height: UIScreen.main.bounds.height / 4)
                                        .clipped()
                                    
                                    Image("BarrioBotanico8") // Replace with your asset names
                                        .resizable()
                                        .aspectRatio(contentMode: .fill)
                                        .frame(width: UIScreen.main.bounds.width / 3, height: UIScreen.main.bounds.height / 4)
                                        .clipped()
