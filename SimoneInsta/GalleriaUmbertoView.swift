//
//  GalleriaUmbertoView.swift
//  SimoneInsta
//
//  Created by Simone Mercolino on 23/11/23.
//

import SwiftUI


struct GalleriaUmbertoView: View {
                ...
                VStack(alignment: .leading, spacing: 0) {
                        ...
                        HStack(alignment: .top) {
                            ...
                            VStack(alignment: .leading, spacing: 2) {
                                ...
                                Text("22°C Partly cloudy")
                                    ...
                                    .accessibilityHint(Text("22°C Partly cloudy"))
                            }
                            .padding(.top, 5)
                        }
                        .padding(.top, 20)
                    ...
                    ScrollView{
                        VStack(alignment: .leading, spacing: 20) {
                            ...
                            VStack(alignment: .leading, spacing: 2) {
                                HStack(spacing: 2) {
                                    Image("GalleriaUmbertoImage1") // Replace with your asset names
                                        .resizable()
                                        .aspectRatio(contentMode: .fill)
                                    ...
                                    Image("GalleriaUmbertoImage2") // Replace with your asset names
                                        .resizable()
                                        .aspectRatio(contentMode: .fill)
                                        .frame(width: UIScreen.main.bounds.width / 3, height: UIScreen.main.bounds.height / 4)
                                        .clipped()
                                    ...
                                    Image("GalleriaUmbertoImage3") // Replace with your asset names
                                        .resizable()
                                        .aspectRatio(contentMode: .fill)
                                        .frame(width: UIScreen.main.bounds.width / 3, height: UIScreen.main.bounds.height / 4)
                                        .clipped()
                                ...
                                HStack(spacing: 2) {
                                    Image("GalleriaUmbertoImage4") // Replace with your asset names
                                        .resizable()
                                        .aspectRatio(contentMode: .fill)
                                        .frame(width: UIScreen.main.bounds.width / 3, height: UIScreen.main.bounds.height / 4)
                                        .clipped()
                                    
                                    Image("GalleriaUmbertoImage5") // Replace with your asset names
                                        .resizable()
                                        .aspectRatio(contentMode: .fill)
                                        .frame(width: UIScreen.main.bounds.width / 3, height: UIScreen.main.bounds.height / 4)
                                        .clipped()
                                    ...
                                    Image("GalleriaUmbertoImage6") // Replace with your asset names
                                        .resizable()
                                        .aspectRatio(contentMode: .fill)
                                        .frame(width: UIScreen.main.bounds.width / 3, height: UIScreen.main.bounds.height / 4)
                                        .clipped()
                                ...
                                HStack(spacing: 2) {
                                    Image("GalleriaUmbertoImage7") // Replace with your asset names
                                        .resizable()
                                        .aspectRatio(contentMode: .fill)
                                        .frame(width: UIScreen.main.bounds.width / 3, height: UIScreen.main.bounds.height / 4)
                                        .clipped()
                                    
                                    Image("GalleriaUmbertoImage8") // Replace with your asset names
                                        .resizable()
                                        .aspectRatio(contentMode: .fill)
                                        .frame(width: UIScreen.main.bounds.width / 3, height: UIScreen.main.bounds.height / 4)
                                        .clipped()
                                    ...
                                    Image("GalleriaUmbertoImage") // Replace with your asset names
                                        .resizable()
                                        .aspectRatio(contentMode: .fill)
                                        .frame(width: UIScreen.main.bounds.width / 3, height: UIScreen.main.bounds.height / 4)
                                        .clipped()
