//
//  PiazzaDanteView.swift
//  SimoneInsta
//
//  Created by Simone Mercolino on 20/11/23.
//

import SwiftUI


struct PiazzaDanteView: View {
                ...
                VStack(alignment: .leading, spacing: 0) {
                    ...
                    ScrollView{
                        VStack(alignment: .leading, spacing: 20) {
                            ...
                            VStack(alignment: .leading, spacing: 2) {
                                HStack(spacing: 2) {
                                    Image("SfogliatellaPiazzaDanteImage") // Replace with your asset names
                                        .resizable()
                                        .aspectRatio(contentMode: .fill)
                                    ...
                                    Image("PiazzaDanteImage1") // Replace with your asset names
                                        .resizable()
                                        .aspectRatio(contentMode: .fill)
                                        .frame(width: UIScreen.main.bounds.width / 3, height: UIScreen.main.bounds.height / 4)
                                        .clipped()
                                    ...
                                    Image("PiazzaDanteImage2") // Replace with your asset names
                                        .resizable()
                                        .aspectRatio(contentMode: .fill)
                                        .frame(width: UIScreen.main.bounds.width / 3, height: UIScreen.main.bounds.height / 4)
                                        .clipped()
                                ...
                                HStack(spacing: 2) {
                                    Image("PiazzaDanteImage3") // Replace with your asset names
                                        .resizable()
                                        .aspectRatio(contentMode: .fill)
                                        .frame(width: UIScreen.main.bounds.width / 3, height: UIScreen.main.bounds.height / 4)
                                        .clipped()
                                    
                                    Image("PiazzaDanteImage4") // Replace with your asset names
                                        .resizable()
                                        .aspectRatio(contentMode: .fill)
                                        .frame(width: UIScreen.main.bounds.width / 3, height: UIScreen.main.bounds.height / 4)
                                        .clipped()
                                ...
                                HStack(spacing: 2) {
                                    Image("PiazzaDanteImage6") // Replace with your asset names
                                        .resizable()
                                        .aspectRatio(contentMode: .fill)
                                        .frame(width: UIScreen.main.bounds.width / 3, height: UIScreen.main.bounds.height / 4)
                                        .clipped()
                                    
                                    Image("PiazzaDanteImage7") // Replace with your asset names
                                        .resizable()
                                        .aspectRatio(contentMode: .fill)
                                        .frame(width: UIScreen.main.bounds.width / 3, height: UIScreen.main.bounds.height / 4)
                                        .clipped()
                                    ...
                                    Image("PiazzaDanteImage") // Replace with your asset names
                                        .resizable()
                                        .aspectRatio(contentMode: .fill)
                                        .frame(width: UIScreen.main.bounds.width / 3, height: UIScreen.main.bounds.height / 4)
                                        .clipped()
