            ...
            VStack(alignment: .leading, spacing: 0) {
                ...
                ScrollView{
                    VStack(alignment: .leading, spacing: 20) {
                        ...
                        VStack(alignment: .leading, spacing: 2) {
                            HStack(spacing: 2) {
                                Image("NennellaSquadImage") // Replace with your asset names
                                    .resizable()
                                    .aspectRatio(contentMode: .fill)
                                ...
                                Image("Pasta&PatateImage") // Replace with your asset names
                                    .resizable()
                                    .aspectRatio(contentMode: .fill)
                                    .frame(width: UIScreen.main.bounds.width / 3, height: UIScreen.main.bounds.height / 4)
                                    .clipped()
                                ...
                                Image("NennellaImage1") // Replace with your asset names
                                    .resizable()
                                    .aspectRatio(contentMode: .fill)
                                    .frame(width: UIScreen.main.bounds.width / 3, height: UIScreen.main.bounds.height / 4)
                                    .clipped()
                            ...
                            HStack(spacing: 2) {
                                Image("NennellaImage5") // Replace with your asset names
                                    .resizable()
                                    .aspectRatio(contentMode: .fill)
                                    .frame(width: UIScreen.main.bounds.width / 3, height: UIScreen.main.bounds.height / 4)
                                    .clipped()
                                
                                Image("NennellaImage6") // Replace with your asset names
                                    .resizable()
                                    .aspectRatio(contentMode: .fill)
                                    .frame(width: UIScreen.main.bounds.width / 3, height: UIScreen.main.bounds.height / 4)
                                    .clipped()
                                ...
                                Image("NennellaImage4") // Replace with your asset names
                                    .resizable()
                                    .aspectRatio(contentMode: .fill)
                                    .frame(width: UIScreen.main.bounds.width / 3, height: UIScreen.main.bounds.height / 4)
                                    .clipped()
                            ...
                            HStack(spacing: 2) {
                                Image("NennellaImage7") // Replace with your asset names
                                    .resizable()
                                    .aspectRatio(contentMode: .fill)
                                    .frame(width: UIScreen.main.bounds.width / 3, height: UIScreen.main.bounds.height / 4)
                                    .clipped()
                                ...
                                Image("NennellaImage3") // Replace with your asset names
                                    .resizable()
                                    .aspectRatio(contentMode: .fill)
                                    .frame(width: UIScreen.main.bounds.width / 3, height: UIScreen.main.bounds.height / 4)
                                    .clipped()
